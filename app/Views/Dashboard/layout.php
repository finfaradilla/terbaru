    ...
    <div class="app-wrapper">
                ...
                <ul class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#"
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img
                                            src="<?= base_url('dashboard') ?>/assets/img/user1-128x128.jpg"
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img
                                            src="<?= base_url('dashboard') ?>/assets/img/user8-128x128.jpg"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            John Pierce
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img
                                            src="<?= base_url('dashboard') ?>/assets/img/user3-128x128.jpg"
                                            alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            Nora Silvester
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                            data-bs-toggle="dropdown"> <img
                                src="<?= base_url('dashboard') ?>/assets/img/user2-160x160.jpg"
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                <!--begin::Brand Link--> <a href="<?= base_url() ?>" class="brand-link">
                    <!--begin::Brand Image--> <img src="<?= base_url('dashboard') ?>/assets/img/AdminLTELogo.png"
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item <?= (!empty($menu_open)) ? 'menu-open' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_poli') ?>" class="nav-link <?= ($name == 'master_poli') ? 'active' : '' ?>">
                                        <p>Master Poli</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_dokter') ?>" class="nav-link <?= ($name == 'master_dokter') ? 'active' : '' ?>">
                                        
                                        <p>Master Dokter</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_tindakan') ?>" class="nav-link <?= ($name == 'master_tindakan') ? 'active' : '' ?>">
                                        
                                        <p>Master Tindakan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_diagnosa') ?>" class="nav-link <?= ($name == 'master_diagnosa') ? 'active' : '' ?>">
                                        
                                        <p>Master Diagnosa</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_administrasi') ?>" class="nav-link <?= ($name == 'master_administrasi') ? 'active' : '' ?>">
                                        
                                        <p>Master Administrasi</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_penunjang') ?>" class="nav-link <?= ($name == 'master_penunjang') ? 'active' : '' ?>">
                                        
                                        <p>Master Penunjang</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_supplier') ?>" class="nav-link <?= ($name == 'master_supplier') ? 'active' : '' ?>">
                                        
                                        <p>Master Supplier</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_obat') ?>" class="nav-link <?= ($name == 'master_obat') ? 'active' : '' ?>">
                                        
                                        <p>Master Obat</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Dashboard/master_kamar') ?>" class="nav-link <?= ($name == 'master_kamar') ? 'active' : '' ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Dashboard/pasien') ?>" class="nav-link <?= ($name == 'pasien') ? 'active' : '' ?>">
                                <i class="nav-icon fa-solid fa-user-nurse"></i>
                                <p>Pasien</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('Dashboard/riwayat_jalan') ?>" class="nav-link <?= ($name == 'riwayat_jalan') ? 'active' : '' ?>">
                                <i class="nav-icon fa-regular fa-calendar-check"></i>
                                <p>Pendaftaran Riwayat Jalan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('Dashboard/rajal') ?>" class="nav-link <?= ($name == 'rajal') ? 'active' : '' ?>">
                                <i class="nav-icon fa-solid fa-folder-closed"></i>
                                <p>Pemeriksaan Rajal</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('Dashboard/rawat_inap') ?>" class="nav-link <?= ($name == 'rawat_inap') ? 'active' : '' ?>">
                                <i class="nav-icon fa-solid fa-bed-pulse"></i>
                                <p>Pendaftaran Rawat Inap</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('Dashboard/ranap') ?>" class="nav-link <?= ($name == 'ranap') ? 'active' : '' ?>">
                                <i class="nav-icon fa-solid fa-folder-closed"></i>
