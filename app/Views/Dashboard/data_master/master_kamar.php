                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('DataMaster/MasterKamar/save') ?>" method="POST">
                                                <?= csrf_field() ?>
                                                <div class="card-body">
                                                    <div class="mb-3">
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle text-center">
                                        ...
                                        <td><?= $value['nama'] ?></td>
                                        <td><?= $value['kelas'] ?></td>
                                        <td>Rp <?= number_format($value['tarif']) ?>/Hari</td>
                                        <td>
                                            <a href="<?= base_url('DataMaster/MasterKamar/edit/'.$value['id']) ?>" class="btn btn-warning">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <button onclick="deleteKamar('<?= $value['kode'] ?>')" class="btn btn-danger">
    ...
    function deleteKamar(id) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('DataMaster/MasterKamar/delete') ?>',
                    type: 'POST',
                    data: {
                        kode: id,
                    },
                    ...
                    error: function(xhr, status, error) {
                        swalWithBootstrapButtons.fire({
                            title: "Dibatalkan",
                            text: "Kode Kamar " + id + ' Gagal Dihapus',
                            icon: "error"
                        });
                    }
                });
